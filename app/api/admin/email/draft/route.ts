...
// AI-written email body for the admin Compose box and Inbox replies. When
// `incoming` (a received message) is supplied, it drafts a reply addressing it.
// Falls back to the keyword template when no ANTHROPIC_API_KEY is set.
