...
export const LIST_REGISTRY: ContentList[] = [
  ...
  },
  {
    ...
    path: "/help",
    itemLabel: "question",
    description: "Questions grouped by section on the Help Centre page. Reuse a section name to add a question to that group.",
    fields: [
      { key: "section", label: "Section" },
      { key: "q", label: "Question" },
      { key: "a", label: "Answer", type: "textarea" },
    ...
    default: [
      { section: "Membership", q: "How do I become a member of Voyages & Co.?", a: "Membership is by application. Submit a request via 'Request Invitation', and a member of our team will be in touch to understand your travel preferences before extending an invitation." },
      { section: "Membership", q: "Is there a membership fee?", a: "We offer tiered memberships tailored to how you travel. Your dedicated specialist will discuss the option best suited to you during onboarding." },
      { section: "Membership", q: "Can I travel with guests?", a: "Of course. Your membership extends to your travelling companions and immediate family, with the same standard of care throughout." },
      { section: "Journeys & Bookings", q: "How are journeys arranged?", a: "Every journey is handcrafted by your dedicated specialist. Share your dates, interests and preferences, and we will design a bespoke itinerary for your approval — refined until perfect." },
      { section: "Journeys & Bookings", q: "Do you handle every element of the trip?", a: "Yes. Flights, private transfers, stays, dining, experiences and on-the-ground support are all arranged and overseen by your concierge." },
      { section: "Journeys & Bookings", q: "How far in advance should I plan?", a: "For the most exclusive stays and experiences, we recommend planning several months ahead. That said, our network allows us to arrange remarkable journeys at short notice." },
      { section: "Concierge & Support", q: "Is support available while I travel?", a: "Always. Your concierge is reachable 24 hours a day, across every time zone, for anything you may need during your journey." },
      { section: "Concierge & Support", q: "What if my plans change?", a: "Simply contact your specialist. We will adjust your itinerary discreetly and handle any arrangements on your behalf." },
      { section: "Concierge & Support", q: "How is my privacy protected?", a: "Discretion is fundamental to who we are. Your information and itineraries are held in the strictest confidence and never shared." },
    ],
  },
  {
    key: "list.aboutValues",
    page: "about-values",
    label: "About — values",
    path: "/about",
    itemLabel: "value",
    description: "The value cards on the About page. Icon is a Lucide name (e.g. Target, Globe, Award).",
    fields: [
      { key: "icon", label: "Icon (Lucide name)" },
      { key: "title", label: "Title" },
    ...
    default: [
      { icon: "Target", title: "Discretion", desc: "Your privacy is sacrosanct. Always." },
      { icon: "Globe", title: "Access", desc: "Doors others cannot open, opened for you." },
      { icon: "Award", title: "Mastery", desc: "Every detail considered, then perfected." },
    ],
  },
  {
    key: "list.partnersTypes",
    page: "partners-types",
    label: "Partners — partnership types",
    path: "/partners",
    itemLabel: "type",
    description: "The partnership cards on the Partners page. Put one benefit per line.",
    fields: [
      { key: "title", label: "Title" },
      { key: "desc", label: "Description", type: "textarea" },
    ...
    default: [
      { title: "Hotels & Resorts", desc: "Present your property to a discerning clientele who value the exceptional and book without hesitation.", benefits: "Curated placement\nDedicated relationship manager\nQualified, high-value guests\nPreferred-partner programme", cta: "Partner with us" },
      { title: "Villas & Private Estates", desc: "Introduce your residence to members seeking privacy, space and impeccable service.", benefits: "Discreet listing\nVetted guests only\nConcierge coordination\nTailored commercial terms", cta: "Become a partner" },
      { title: "Experience Curators", desc: "Share your rare, once-in-a-lifetime experiences with travellers who seek precisely that.", benefits: "Storytelling support\nSeamless coordination\nPremium positioning\nLong-term collaboration", cta: "Collaborate" },
    ],
  },
  {
    key: "list.pressMentions",
    page: "press-mentions",
    label: "Press — mentions",
    path: "/press",
    itemLabel: "mention",
    fields: [
      { key: "outlet", label: "Publication" },
      { key: "quote", label: "Quote", type: "textarea" },
      { key: "date", label: "Year" },
    ],
    default: [
      { outlet: "The Grand Tourer", quote: "The rare travel atelier that treats an itinerary as a piece of writing — every transition considered, nothing left to chance.", date: "2026" },
      { outlet: "Escape Quarterly", quote: "Voyages & Co.'s Bhutan circuit is the most thoughtfully paced spiritual journey we've taken in a decade of covering the region.", date: "2025" },
      { outlet: "Maison & Meridian", quote: "What sets them apart isn't the five-star access — everyone in this category has that. It's the restraint in how they use it.", date: "2025" },
      { outlet: "The Wanderer's Almanac", quote: "A private aviation desk that actually understands the difference between a light jet and a long-haul — rarer than it should be.", date: "2025" },
      { outlet: "Atlas Review", quote: "Among the small handful of bespoke operators we'd trust with a first visit to the Maldives or a first visit anywhere.", date: "2024" },
    ],
  },
  {
    key: "list.pressFacts",
    page: "press-facts",
    label: "Press — company facts",
    path: "/press",
    itemLabel: "fact",
    fields: [
  ...
  },
  {
    ...
    default: [
      ...
      { column: "Maison", label: "Events", href: "/events" },
