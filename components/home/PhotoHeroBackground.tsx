 ...
 * instead of a blank world map with nothing on it. Held still (no ken-burns)
 * so it matches the other tabs' interactive maps, which don't move on their
 * own either — only the visitor's own interaction pans/zooms them.
 */
