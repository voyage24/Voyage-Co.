      ...
      <svg viewBox={`0 0 ${W} ${H}`} className="w-full h-auto" role="img" aria-label="Bookings over the last 14 days">
        <defs>
          <linearGradient id="chartFill" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0" stopColor="#00C4CC" stopOpacity="0.5" />
        ...
        {data.map((d, i) => (
          <g key={i}>
            <circle cx={X(i)} cy={Y(d.count)} r="3" fill="#00C4CC" stroke="currentColor" strokeWidth="1.5" className="chart-dot" style={{ animationDelay: `${0.5 + i * 0.05}s` }}>
