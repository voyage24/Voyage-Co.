  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-[5.25rem] left-4 sm:bottom-5 sm:left-5 z-40 flex items-center gap-2 bg-[#15212D] text-[#f4f0e9] pl-3 pr-4 py-2.5 rounded-full shadow-luxury hover:scale-105 active:scale-95 transition-[transform,opacity] duration-300 ${hidden ? "translate-y-24 opacity-0 pointer-events-none" : "translate-y-0 opacity-100"}`}
      >
