...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-40 w-9 h-9 rounded-full bg-white/10 backdrop-blur-sm border border-white/25 flex items-center justify-center transition-transform duration-200 hover:scale-110 active:scale-95"
    >
