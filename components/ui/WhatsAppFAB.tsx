...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-[5.25rem] right-4 sm:bottom-5 sm:right-5 z-40 w-11 h-11 sm:w-10 sm:h-10 flex items-center justify-center transition-[transform,opacity] duration-300 hover:scale-110 active:scale-95 ${hidden ? "translate-y-24 opacity-0 pointer-events-none" : "translate-y-0 opacity-100"}`}
    >
      <svg viewBox="0 0 32 32" className="wa-glow w-full h-full" aria-hidden="true">
        <circle cx="16" cy="16" r="15.5" fill="#25D366" stroke="#fff" strokeWidth="1" />
