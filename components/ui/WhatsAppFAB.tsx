...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 w-11 h-11 rounded-full bg-[#25D366] shadow-luxury flex items-center justify-center transition-transform duration-200 hover:scale-110 active:scale-95"
    >
