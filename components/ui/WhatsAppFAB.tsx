...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-[5.25rem] right-4 sm:bottom-5 sm:right-5 z-40 flex items-center gap-2 bg-ink text-page pl-2.5 pr-4 py-2.5 rounded-full shadow-luxury transition-[transform,opacity] duration-300 hover:scale-105 active:scale-95 ${hidden ? "translate-y-24 opacity-0 pointer-events-none" : "translate-y-0 opacity-100"}`}
    >
      ...
      <span className="text-shimmer text-[11px] tracking-[0.12em] uppercase whitespace-nowrap">WhatsApp us</span>
    </a>
  );
}
