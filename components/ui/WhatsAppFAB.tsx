...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-40 w-6 h-6 rounded-full bg-white/15 backdrop-blur-sm border border-white/30 shadow-card flex items-center justify-center transition-transform duration-200 hover:scale-110 active:scale-95"
    >
      <svg viewBox="0 0 32 32" width="12" height="12" fill="#25D366" aria-hidden="true">
