...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-40 w-8 h-8 rounded-full bg-[#25D366] shadow-luxury flex items-center justify-center transition-transform duration-200 hover:scale-110 active:scale-95"
    >
      <svg viewBox="0 0 32 32" width="15" height="15" fill="#fff" aria-hidden="true">
