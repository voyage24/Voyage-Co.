...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-[#25D366] shadow-luxury flex items-center justify-center transition-transform duration-200 hover:scale-110 active:scale-95"
    >
