...
export default function Logo({
  ...
  const mark = customLogo ? (
    ...
    <span
      className={`font-logo ${shimmer ? "font-semibold" : "font-normal"} leading-none tracking-[0.04em] ${shimmer ? (tone === "light" ? "shimmer-gold-hero" : "shimmer-gold") : color} transition-colors duration-300`}
      style={{ fontSize: size }}
    >
